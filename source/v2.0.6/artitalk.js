...
if ( typeof(slanguage) == "undefined" ) {
  ...
  if(slanguage=="zh"){
    ...
    var text25="如果你看到这条说说，很遗憾的告诉你。在你关于leancloud中的配置出错了。<br>常见的错误有：没有创建名为shuoshuo的class，权限设置错误等。若仍然无法解决，请前往官网查看FAQ，或者加入QQ交流群：1104585229<br>当你解决错误后，我会自动消失";
    var textup="上传ing";
    ...
    var text25="If you see this talk, I regret to tell you. There is an error in your configuration about leancloud. <br>Common mistakes are: class named shuoshuo is not created, permissions are set incorrectly, etc. If you still can't solve it, please go to the official website to check the FAQ, or join the QQ communication group: 1104585229<br>When you solve the error, I will disappear automatically";
    ...
    var text25="Si ves esta charla, lamento decírtelo. Hay un error en su configuración sobre leancloud. <br> Los errores comunes son: la clase llamada shuoshuo no se crea, los permisos se configuran incorrectamente, etc. Si aún no puede resolverlo, vaya al sitio web oficial para consultar las preguntas frecuentes o únase al grupo de comunicación QQ: 1104585229 <br> Cuando resuelva el error, desapareceré automáticamente";
    var textup="Cargando";
  }
...
if(lazy==0){
  ...
  if(leancloud_wrong==1){
    var string="<ul class=\"cbp_tmtimeline\" id=\"maina\"><li><span class=\"shuoshuo_author_img\"><img src=\"https://cdn.jsdelivr.net/gh/drew233/cdn/logol.png\" class=\"avatar avatar-48\" width=\"48\" height=\"48\"></span><span class=\"cbp_tmlabel\"><p>"+text25+"</p><p class=\"shuoshuo_time\"><span style=\"\"> 由Artitalk发表</span><span style=\"float:right;\"><svg t=\"1591350675688\" class=\"icon\" viewBox=\"0 0 1025 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"28653\" width=\"10\" height=\"10\" style=\"display: inline\"></svg> 2020-04-10 </span></p></span></li></ul>";
    document.getElementById("ccontent").innerHTML=string;
  }
