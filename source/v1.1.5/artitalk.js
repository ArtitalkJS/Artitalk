...
function uploadimg(file){
    ...
    var settings = {
        ...
        "async": true,
        "headers": {
          "Authorization": "Bearer 7ce68a891f6f66c70d548fa882837a0867b265c8",
...
var sting="<link rel=\"stylesheet\" href=\"https://cdn.bootcss.com/font-awesome/5.13.0/css/all.min.css\" media=\"all\"><div id=\"main\" class=\"site-main\" role=\"main\"><div id=\"shuoshuo_content\"><div id=\"ccontent\"></div></div><div id=\"shuoshuo_input\" class=\"shuoshuo_active\" style=\"display: none;\"><div id=\"shuoshuo_edit\"><textarea class=\"shuoshuo_text\" id=\"neirong\" placeholder=\""+placeholder1+"\"style=\"background-image: url("+bgimg+");\"></textarea></div><div class=\"shuoshuo_submit\"><div class=\"shuoshuo_row\"><input class=\"child input\" type=\"password\" id=\"key\" value=\"\" placeholder=\"请输入密码\" autocomplete=\"off\"><input class=\"child input\" id=\"touxiang\" value=\"\" placeholder=\""+placeholder3+"\"><div class=\"child\"><button class=\"button\" onclick=\"savecontent()\" style=\"float: right;\">发布</button><button class=\"button\" onclick=\"preview()\" style=\"float: right;\">预览</button></div></div><div class=\"shuoshuo_row\"><div id=\"preview\"></div></div></div></div><div class=\"power\"><div style=\"font-size: 30px; cursor: pointer\" onclick=\"$(\'.shuoshuo_active').fadeIn()\">✍️</div>Powered By <a href=\"https://artitalk.js.org\" target=\"_blank\">Artitalk</a><br>"+version+"</div></div>";
