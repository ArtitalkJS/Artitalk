...
for (var key in atemoji_array) {
    artitalk_emoji=artitalk_emoji+"<img alt='["+key+"]' title='"+key+"' onclick='insert_atemoji(\"["+key+"]\")' class='atemoji' src='"+atemoji_array[key]+"'</img>";
}
...
if(lazy==0){
  ...
  function preview(){
      ...
      for (var key in atemoji_array){
          var key_at="["+key+"]";
          var emoji_at="<img class='atemoji' src='"+atemoji_array[key]+"'</img>";
