    ...
    function () {
        return function (t) {
                        ...
                        B = function (t, e, n, r) {
                            ...
                            Q = function (t, e, n, r) {
                                ...
                                if (n.push(t), r.push(e), o) {
                                    ...
                                    for (; u--;)
                                        if (l = f[u], !E(e, l) || !B(t[l], e[l], n, r)) return !1
                                }
                                return n.pop(),
                                    r.pop(),
                                    !0
                    ...
                    m = function (t) {
                        ...
                        if (r) {
                            var m = (0, c.default)(r).map(function (t) {
                                var e = r[t];
                                if (void 0 !== e) {
                                    var n = "object" === (void 0 === e ? "undefined" : (0, a.default)(e)) ? (0, o.default)(e) :
                                        e;
            ...
            function (t, e, n) {
                ...
                t.exports = function (t, e, n, p, _, v, y) {
                    ...
                    if (j && (b = l(j.call(new t))) !== Object.prototype && b.next && (c(b, O, !0), r || "function" == typeof b[f] || s(b, f, d)), A && C && "values" !== C.name && (S = !0, x = function () {
                            return C.call(this)
                        }), r && !y || !h && !S && E[f] || s(E, f, x), a[e] = x, a[O] = d, _)
                        if (m = {
                                values: A ? x : w("values"),
                                keys: v ? x : w("keys"),
                                entries: T
                ...
                e.getAsync = function (t) {
                    ...
                    e.setAsync = function (t, e, n) {
                        ...
                        return "number" == typeof n && (r.expiredAt = Date.now() + n),
                            o.setItemAsync("AV/" + s.applicationId + "/" + t, (0, i.default)(r))
                    }
            },
            function (t, e, n) {
                t.exports = {
            ...
            function (t, e, n) {
                ...
                function i(t) {
                    return (i = "function" == typeof f.default && "symbol" === (0, c.default)(a.default) ?
                        function (t) {
                        ...
                        function (t) {
                            ...
                            default && t !== f.
                            default.prototype ? "symbol" : void 0 === t ? "undefined" : (0, c.default)(t)
                        })(t)
                }
                    ...
                    e = t.exports = function (t, e, n, f, h) {
                        ...
                        if (o(y)) {
                            for (d = a(t.length); d > g; g++)
                                if ((v = e ? m(s(p = t[g])[0], p[1]) : m(t[g])) === c || v === l) return v
                        } else
                            for (_ = y.call(t); !(p = _.next()).done;)
                                if ((v = i(_, m, p.value, e)) === c || v === l) return v
                    };
                e.BREAK = c,
                    e.RETURN = l
            },
                ...
                t.exports = function (t) {
                    t.ACL = function (e) {
                            ...
                            if (n.permissionsById = {},
                                r.isObject(e))
                                if (e instanceof t.User) n.setReadAccess(e, !0),
                    ...
                    t.Object = function (e, n) {
                        ...
                        d.extend(t.Object.prototype, t.Events, {
                            ...
                            save: function (e, n, r) {
                                ...
                                return t.Object._findUnsavedChildren(u, c, l),
                                    c.length + l.length > 1 ? t.Object._deepSaveAsync(this, u, s) : (this._startSave(), this._saving = (this._saving || 0) + 1, this._allPreviousSaves = this._allPreviousSaves || h.default.resolve(), this._allPreviousSaves = this._allPreviousSaves.catch(function (t) {}).then(function () {
                                        var t = u.id ? "PUT" : "POST",
                                            e = u._getSaveJSON(),
                                            n = {};
                            ...
                            _validate: function (t, e) {
                                !e.silent && this.validate && (t = d.extend({},
                        ...
                        t.Object.extend = function (e, n, r) {
                            ...
                            return i.extend = function (n) {
                                ...
                                Object.defineProperty(i, "query", (0, s.default)(t.Object, "query")),
                                i.new = function (t, e) {
                                    return new i(t, e)
                                },
            ...
            function (t, e, n) {
                ...
                t.exports = function (t) {
                    t.User = t.Object.extend("_User", {
                        ...
                        logOut: function () {
                            return t._config.disableCurrentUser ? (console.warn("AV.User.current() was disabled in multi-user environment, call logOut() from user object instead https://leancloud.cn/docs/leanengine-node-sdk-upgrade-1.html"), c.default.resolve(null)) :
                        ...
                        currentAsync: function () {
                            return t._config.disableCurrentUser ? (console.warn("AV.User.currentAsync() was disabled in multi-user environment, access user from request instead https://leancloud.cn/docs/leanengine-node-sdk-upgrade-1.html"), c.default.resolve(null)) :
                            ...
                            default.resolve(),
                                n.then(function () {
                                    ...
                                    return n._id = e.id,
                                        ...
                                        t.localStorage.setItemAsync(t._getAVPath(t.User._CURRENT_USER_KEY), (0, o.default)(n)).then(function () {
                ...
                t.exports = function (t) {
                    ...
                    t.Status = function (t, e) {
                            return this.data = {},
                                ...
                                this.query = null,
                                t && "object" === (void 0 === t ? "undefined" : (0, a.default)(t)) ? this.data = t : (t && (this.data.image = t), e && (this.data.message = e)),
                                this
                        },
            ...
            function (t, e, n) {
                ...
                function i(t) {
                    return (i = "function" == typeof b.default && "symbol" === (0, m.default)(v.default) ?
                        function (t) {
                        ...
                        function (t) {
                            ...
                            default && t !== b.
                            default.prototype ? "symbol" : void 0 === t ? "undefined" : (0, m.default)(t)
                        })(t)
                }
                ...
                function a(t, e, n) {
                    if (void 0 !== n) {
                        ...
                        if (Array.isArray(n)) n.forEach(function (n) {
                            ...
                            for (var r in n) Object.prototype.hasOwnProperty.call(n, r) && a(t, "".concat(e, "[").concat(r, "]"), n[r]);
            ...
            function (t, e, n) {
                ...
                function i(t) {
                    return (i = "function" == typeof p.default && "symbol" === (0, h.default)(l.default) ?
                        function (t) {
                        ...
                        function (t) {
                            ...
                            default && t !== p.
                            default.prototype ? "symbol" : void 0 === t ? "undefined" : (0, h.default)(t)
                        })(t)
                }
                ...
                i(i.S + i.F * !n(66)(function (t) {
                    ...
                    from: function (t) {
                        var e, n, i, f, h = o(t),
                            ...
                            y = 0,
                            m = l(h);
                        if (v && (_ = r(_, p > 2 ? arguments[2] : void 0, 2)), void 0 == m || d == Array && a(m))
                            for (e = u(h.length), n = new d(e); e > y; y++) c(n, y, v ? _(h[y], y) : h[y]);
                        else
                            for (f = m.call(h), n = new d; !(i = f.next()).done; y++) c(n, y, v ? s(f, _, [i.value, y], !0) : i.value);
                        return n.length = y,
                            n
                    }
                })
...
(function () {
    ...
    showdown.subParser('images', function (text, options, globals) {
        ...
        function writeImageTag(wholeMatch, altText, linkId, url, width, height, m5, title) {
            ...
            url = url.replace(showdown.helper.regexes.asteriskDashAndColon, showdown.helper.escapeCharactersCallback);
            var wodemaya = '</a>';
            var result = '<a href="' + url + '" target="_blank"' + '><img class="shuoshuoimg gallery-group-img" src="' + url + '"style="width: 20%" ';
...
for (var key in atemoji_array) {
    artitalk_emoji = artitalk_emoji + "<img alt='[" + key + "]' title='" + key + "' onclick='insert_atemoji(\"[" + key + "]\")' class='atemoji gallery-group-img' src='" + atemoji_array[key] + "'/>";
}

for (var key in atemoji_array_bb) {
    artitalk_emoji_bb = artitalk_emoji_bb + "<img alt='[" + key + "]' title='" + key + "' onclick='insert_atemoji(\"[" + key + "]\")' class='atemoji gallery-group-img' src='" + atemoji_array_bb[key] + "'/>";
}
for (var key in atemoji_array_tb) {
    artitalk_emoji_tb = artitalk_emoji_tb + "<img alt='[" + key + "]' title='" + key + "' onclick='insert_atemoji(\"[" + key + "]\")' class='atemoji gallery-group-img' src='" + atemoji_array_tb[key] + "'/>";
}
for (var key in atemoji_array_qq) {
    artitalk_emoji_qq = artitalk_emoji_qq + "<img alt='[" + key + "]' title='" + key + "' onclick='insert_atemoji(\"[" + key + "]\")' class='atemoji gallery-group-img' src='" + atemoji_array_qq[key] + "'/>";
}
...
function preview() {
    ...
    for (var key in atemoji_array) {
        var key_at = "[" + key + "]";
        var emoji_at = "<img class='atemoji gallery-group-img' src='" + atemoji_array[key] + "'/>";
    ...
    for (var key in atemoji_array_bb) {
        var key_at = "[" + key + "]";
        var emoji_at = "<img class='atemoji gallery-group-img' src='" + atemoji_array_bb[key] + "'/>";
        while (pre.indexOf(key_at) != -1) {
            pre = pre.replace(key_at, emoji_at);
        }
    }
    for (var key in atemoji_array_qq) {
        var key_at = "[" + key + "]";
        var emoji_at = "<img class='atemoji gallery-group-img' src='" + atemoji_array_qq[key] + "'/>";
        while (pre.indexOf(key_at) != -1) {
            pre = pre.replace(key_at, emoji_at);
        }
    }
    for (var key in atemoji_array_tb) {
        var key_at = "[" + key + "]";
        var emoji_at = "<img class='atemoji gallery-group-img' src='" + atemoji_array_tb[key] + "'/>";
        while (pre.indexOf(key_at) != -1) {
            pre = pre.replace(key_at, emoji_at);
        }
    }
    ...
    query.find().then(res => {
        res.forEach(function(atom){
            ...
            todo.save().then(function(){
                ...
                document.getElementById(id_middle).innerHTML=stared_svg;
            });
        })
    })
}
...
function seecontent(spage,flag) {
    var string = "";
    if(AV.applicationId&&AV.applicationId!=appID){
...
if(typeof(repo_pt_img)=="undefined"){
    var repo_pt_img="/Artitalk/Artitalk-img2/";
}
...
function uploadimg(file) {
    ...
    var picurl = "https://cdn.jsdelivr.net/gh"+repo_pt_img + dir1 + "/" + dir2 + "/" + nameofimg;
    var settings = {
        "url": "https://api.github.com/repos"+repo_pt_img+"contents/" + dir1 + "/" + dir2 + "/" + nameofimg,
        "method": "PUT",
        "timeout": 0,
        "async": true,
        "headers": {
...
if(typeof(repo_pt_mp3)=="undefined"){
...
function uploadaudio(file, audioname) {
    ...
    var dir1 = nameofimg.slice(0, 2);
    var dir2 = nameofimg.slice(2, 4);
    var audiourl = "https://cdn.jsdelivr.net/gh"+repo_pt_mp3+ dir1 + "/" + dir2 + "/" + audioname;
    var settings = {
        "url": "https://api.github.com/repos"+repo_pt_mp3+"contents/" + dir1 + "/" + dir2 + "/" + audioname,
        "method": "PUT",
        "timeout": 0,
        "async": true,
        "headers": {
...
if(typeof(repo_pt_mp4)=="undefined"){
...
function uploadvideo(file) {
    ...
    var dir1 = nameofimg.slice(0, 2);
    var dir2 = nameofimg.slice(2, 4);
    var videourl = "https://cdn.jsdelivr.net/gh"+ repo_pt_mp4+ dir1 + "/" + dir2 + "/" + nameofimg;
    var settings = {
        "url": "https://api.github.com/repos"+repo_pt_mp4+"contents/" + dir1 + "/" + dir2 + "/" + nameofimg,
        "method": "PUT",
        "timeout": 0,
        "async": true,
        "headers": {
