...
var sting="<div id=\"main\" class=\"site-main\" role=\"main\"><div id=\"shuoshuo_content\"><div id=\"ccontent\"></div></div><div id=\"shuoshuo_input\" class=\"shuoshuo_active\" style=\"display: none;\"><div id=\"shuoshuo_edit\"><textarea class=\"shuoshuo_text\" id=\"neirong\" placeholder=\""+placeholder1+"\"style=\"background-image: url("+bgimg+");\"></textarea></div><div class=\"shuoshuo_submit\"><div class=\"shuoshuo_row\"><input class=\"child shuoshuo_inputs\" id=\"touxiang\" value=\"\" placeholder=\""+placeholder2+"\"><div class=\"child\"><button class=\"button\" onclick=\"savecontent()\" style=\"float: right;\">发布</button><button class=\"button\" onclick=\"preview()\" style=\"float: right;\">预览</button></div></div><div class=\"shuoshuo_row\"><div id=\"preview\"></div></div></div></div><div class=\"power\"><div style=\"font-size: 25px;display: inline; cursor: pointer\" onclick=\"artitalk(); \"title=\"发布说说\">✍️</div><div style=\"font-size: 25px;display: inline; cursor: pointer\" onclick=\"myimg.click()\"title=\"上船图片\">🚢</div><div style=\"font-size: 25px;display: inline; cursor: pointer\" onclick=\"swtichuser()\" title=\"登录\">👤</div><br>Powered By <a href=\"https://artitalk.js.org\" target=\"_blank\">Artitalk</a><br>"+version+"</div></div><input type=\"file\" id=\"myimg\" onchange=\"imgChange(this)\" style=\"visibility: hidden;\" accept=\"image/png,image/gif,image/jpeg\"/><div id=\"shade\" class=\"c1 hide\"></div><div id=\"modal\" class=\"c2 hide\"><center><p>用户：<input type=\"text\" class=\"shuoshuo_input_log\" id=\"username\"/></p><p>密码：<input type=\"password\" class=\"shuoshuo_input_log\"  id=\"pwd\"/></p><p><input type=\"button\" value=\"登录\" class=\"button\" onclick=\"Login();\">&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"button\" value=\"取消\"  class=\"button\" onclick=\"Hide();\"></p></center><center><div id=\"logw\"></div></center></div><div id=\"userinfo\" class=\"c2 hide\"><center><p><div id=\"status\"></div></p><p><input type=\"button\" class=\"button\" value=\"确定\" onclick=\"hideuser();\">&nbsp;&nbsp;&nbsp;&nbsp;<input id=\"tui\" type=\"button\" value=\"退出登录\" class=\"button\" style=\"display: none;\" onclick=\"Louout();\"></p></center></div><div id=\"shanchu\" class=\"c2 hide\"><center><p>删除成功</p><p><input type=\"button\" class=\"button\" value=\"确定\" onclick=\"hide3();\"></p><center></div><div id=\"shanchur\" class=\"c2 hide\"><center><p>确定删除本条说说吗？</p><p><div id=\"delete1\"></div></p><center></div>";
 ...
 function Hide(){
  ...
  function Login(){
    ...
    AV.User.logIn(username,password).then(function (loginedUser) {   
      ...
      document.getElementById("logw").innerHTML="<center><pre><code>登陆失败，请检查用户名及密码是否正确</code></pre></center>";
    });
  }
  function hideuser(){
    document.getElementById('shade').classList.add('hide');
  ...
  function shuoshuo_delete(id){
    ...
    if(currentUser){
      ...
      document.getElementById('delete1').innerHTML="<input type=\"button\" class=\"button\" value=\"确定\" onclick=\"really_shanchu(\'"+id+"\')\"><input type=\"button\" class=\"button\" value=\"取消\" onclick=\"hide4()\">";
    }else{
      document.getElementById("logw").innerHTML="<center><pre><code>请先登录</code></pre></center>";
      Show();
      return ;
