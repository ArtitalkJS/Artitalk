...
if(lazy==0){
  ...
  function shuoshuo_emoji_fuckfancybox(){
    if($("#shuoshuo_emoji").hasClass('hide')){
    document.getElementById('shuoshuo_emoji').classList.remove('hide');
    document.getElementById("shuoshuo_emoji").innerHTML = artitalk_emoji;
    }else{
        document.getElementById('shuoshuo_emoji').classList.add('hide');
    }
  }
  function artitalk(){
    var currentUser = AV.User.current();
