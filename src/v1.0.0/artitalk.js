...
$('head').append('<script src=\"https://cdn.jsdelivr.net/gh/drew233/Artitalk/src/os.min.js\"></script>');
if(placeholder1==""){
    placeholder1="";
}
if(placeholder2==""){
