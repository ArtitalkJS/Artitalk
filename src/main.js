(() => {
    ...
    var color1 = window.artitalkConfig.color1 || "RGBA(255, 125, 73, 0.75)",
        color2 = window.artitalkConfig.color2 || "#9BCD9B",
        color3 = window.artitalkConfig.color3 || "white";
    ...
    var artitalk_emoji = "",
        ...
        artitalk_emoji_tb = "",
        artitalk_emoji_qq = "",
        atemoji_array = window.artitalkConfig.atEmoji || {};
    ...
    var repo_pt_img = window.artitalkConfig.repoImg || "/Artitalk/Artitalk-img2/";
    ...
    var repo_pt_mp3 = window.artitalkConfig.repoMp3 || "/Artitalk/Artitalk-mp3/";
    ...
    var repo_pt_mp4 = window.artitalkConfig.repoMp4 || "/Artitalk/Artitalk-mp4/";
