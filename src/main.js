    ...
    try{
        ...
        query.find().then(function (shuoContent){
            ...
            shuoContent.forEach(function(atContent){
                ...
                // Avatar init
                let shuoAvatar = atContent.attributes.atAvatar;
                ...
                let contengMid = "<li><span class=\"shuoshuo_author_img\"><img src=\"" + shuoAvatar + "\"class=\"artitalk_avatar gallery-group-img\" width=\"48\" height=\"48\"></span><span class=\"cbp_tmlabel\" ><div " + hideIcon + " class=\"delete_right\" title=\"" + text23 + "\"onclick=\"atEvery.prototype.delete('"+id+"')\"  ><svg t=\"1591347978744\"  viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"14459\" width=\"20\" height=\"20\" style=\"display: inline\" ><path d=\"M512 883.2A371.2 371.2 0 1 0 140.8 512 371.2 371.2 0 0 0 512 883.2z m0 64a435.2 435.2 0 1 1 435.2-435.2 435.2 435.2 0 0 1-435.2 435.2z\" p-id=\"14460\" fill=\"" + color3 + "\"></path><path d=\"M557.056 512l122.368 122.368a31.744 31.744 0 1 1-45.056 45.056L512 557.056l-122.368 122.368a31.744 31.744 0 1 1-45.056-45.056L466.944 512 344.576 389.632a31.744 31.744 0 1 1 45.056-45.056L512 466.944l122.368-122.368a31.744 31.744 0 1 1 45.056 45.056z\" p-id=\"14461\" fill=\"" + color3 + "\"></path></svg></div>" + shuoshuoPerContent + "<p class=\"shuoshuo_time\">" + "<span style=\"\"> " + " " + osSvg + atOs + "</span><span>&nbsp&nbsp" + timeSvg + resDate + " " + resTime + "" + "</span><span style='float: right'><span style='vertical-align:top;' id='artitalk_star_svg_"+id+"'>"+starSvg+"</span>&nbsp<span style='vertical-align:top;' id='"+id+"'>loading</span></span></p></span></li>";
                mid += contengMid;
            })  
            ...
            shuoContent.forEach(function(atContent){
                let id=atContent.id;
                let starQuery = new AV.Query('shuoshuo');
                starQuery.equalTo('objectId', id);
                starQuery.find().then(function(res) {
                    res.forEach(function(atom){
                        let starNow=atom.attributes.atStar;
            ...
            if(shuoNum !== 0){
                ...
                document.getElementById('readmore').innerHTML = '<center>已经到底了哦~</center>';
                document.getElementById('readmore').id = 'contentOver';
            }
        })
    }catch(error){
        console.log(error);
