...
atEvery.prototype.seeContent = function (pageNum, option) {
    ...
    atEvery.prototype.saveComment = function (id, option) {
        ...
        atComment.save().then(function (res) {
            ...
            commentList.innerHTML = "<span class=\"shuoshuo_author_img\"><img src=\"" + atGravatar + "\"class=\"artitalk_avatar gallery-group-img\" width=\"48\" height=\"48\"></span><span class=\"cbp_tmlabel\"  >  <div>" + atCommentHtml + "</div><p class=\"shuoshuo_time\">" + "<span>" + comNick + "</span><span>&nbsp&nbsp" + timeSvg + resDate + " " + resTime + replySvg + "</span></p></span>".trim();
